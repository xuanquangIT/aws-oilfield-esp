...
| M4 Operations/security | M2 + M3 / AWS accepted | Cloud batch completion, scoped retry/catch, publish gate, expiry lease, drain, least privilege, denial simulation, export/restore tooling and residual cost inventory; live drain, expiry, denial and two destructive export/reset/recreate/restore proofs recorded |
